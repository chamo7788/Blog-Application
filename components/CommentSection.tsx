    ...
    <section className="mt-16 pt-12 border-t border-gray-100">
      <div className="flex items-center justify-between mb-8">
        <h2 className="text-2xl font-bold text-gray-900">
          Responses <span className="text-gray-400 font-normal ml-2">{comments.length}</span>
        </h2>
      </div>

      <div className="mb-12">
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
          <p className="text-sm text-gray-500 mb-3">Share your thoughts...</p>
          <div className="flex justify-end">
            <button className="bg-gray-900 text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-black transition-colors disabled:opacity-50">
              Respond
            </button>
          </div>
        </div>
      ...
      {comments.length === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-2xl border border-dashed border-gray-200">
          <p className="text-gray-500">No responses yet. Be the first to share your thoughts!</p>
        </div>
      ) : (
