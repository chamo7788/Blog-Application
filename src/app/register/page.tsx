    ...
    <div className="max-w-md mx-auto mt-16 p-8 bg-white rounded-2xl shadow-sm border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input required className="w-full px-4 py-2 border rounded-xl" value={name} onChange={e=>setName(e.target.value)} />
        </div>
        <div>
        ...
        <button type="submit" disabled={isLoading} className="w-full bg-gray-900 text-white py-2.5 rounded-xl font-medium mt-2 disabled:bg-gray-700">
